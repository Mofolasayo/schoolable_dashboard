...
export const SUPER_ADMIN_AVATAR_SEED = 'worksight-super-admin-2026';
...
/**
 * Get avatar URL for staff/team members using the dashboard DiceBear style.
 */
export function getStaffAvatarUrl(profile: {
  avatar_url?: string | null;
  gender?: string | null;
  employee_id?: string | null;
...
export function getTeamLeadAvatarUrl(lead: {
  ...
  const seed =
    lead.employeeId || lead.id || lead.email || lead.name || 'default-lead';
